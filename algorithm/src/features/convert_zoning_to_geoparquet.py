...
CHUNKS_DIR = ROOT / "data" / "raw" / "nsw_zoning" / "chunks"
OUTPUT_DIR = ROOT / "data" / "processed" / "nsw_zoning"
OUTPUT_PATH = OUTPUT_DIR / "land_zoning.parquet"
...
def main() -> None:
    ...
    if not frames:
        raise RuntimeError(f"No zoning chunk files could be read.")

    print("Concatenating zoning frames...")
    ...
    if failed:
        ...
        print("\nAll zoning chunks read successfully.")
