...
CHUNKS_DIR = ROOT / "data" / "raw" / "nsw_bushfire" / "chunks"
OUTPUT_DIR = ROOT / "data" / "processed" / "nsw_bushfire"
OUTPUT_PATH = OUTPUT_DIR / "bushfire.parquet"
...
def main() -> None:
    ...
    if not frames:
        raise RuntimeError("No bushfire chunk files could be read.")

    print("Concatenating bushfire frames...")
    ...
    if failed:
        ...
        print("\nAll bushfire chunks read successfully.")
