...
CHUNKS_DIR = ROOT / "data" / "raw" / "nsw_heritage" / "chunks"
OUTPUT_DIR = ROOT / "data" / "processed" / "nsw_heritage"
OUTPUT_PATH = OUTPUT_DIR / "heritage.parquet"
...
def main() -> None:
    ...
    if not frames:
        raise RuntimeError("No heritage chunk files could be read.")

    print("Concatenating heritage frames...")
    ...
    if failed:
        ...
        print("\nAll heritage chunks read successfully.")
