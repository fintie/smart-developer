...
const listings: Listing[] = [
  { id: "ryde", address: "18 Banksia Street, Ryde NSW 2112", suburb: "Ryde", image: "/listing-ryde.png", price: 2180000, priceGuide: "$2.10m–$2.30m", valuation: 2240000, valuationLow: 2110000, valuationHigh: 2390000, rent: 1180, beds: 4, baths: 2, cars: 2, land: 612, type: "House", listed: "Listed 6 days ago", inspection: "Sat 10:30–11:00 am", description: "A modern family home on a level parcel, close to transport, schools and village amenities. The regular lot shape and established residential context support a clear long-term hold profile.", zoning: "R2 Low Density Residential", risk: "No major flood, bushfire or heritage flag in the current screening dataset.", history: [{ date: "20 Sep 2026", event: "Listed for sale", price: "Guide $2.10m–$2.30m" }, { date: "14 Mar 2018", event: "Sold", price: "$1,420,000" }] },
  { id: "epping", address: "42 Orchard Road, Epping NSW 2121", suburb: "Epping", image: "/listing-epping.png", price: 1960000, priceGuide: "Auction guide $1.90m", valuation: 2015000, valuationLow: 1880000, valuationHigh: 2150000, rent: 1050, beds: 4, baths: 3, cars: 1, land: 438, type: "Townhouse", listed: "Auction in 9 days", inspection: "Sat 12:00–12:30 pm", description: "Contemporary accommodation with strong rail access and practical family amenity. Rental demand is supported by nearby education, retail and employment connections.", zoning: "R3 Medium Density Residential", risk: "Low constraint screen; verify strata, easements and site-specific controls.", history: [{ date: "18 Sep 2026", event: "Listed for auction", price: "Guide $1.90m" }, { date: "11 Jul 2020", event: "Sold", price: "$1,510,000" }] },
  { id: "meadowbank", address: "7/61 Park Avenue, Meadowbank NSW 2114", suburb: "Meadowbank", image: "/listing-meadowbank.png", price: 925000, priceGuide: "$900,000–$950,000", valuation: 938000, valuationLow: 880000, valuationHigh: 995000, rent: 760, beds: 2, baths: 2, cars: 1, land: 0, type: "Apartment", listed: "Listed yesterday", inspection: "Wed 5:00–5:30 pm", description: "Well-connected apartment within walking distance of rail, ferry, parks and local shops. A lower-maintenance option with a comparatively strong indicative rental yield.", zoning: "R4 High Density Residential", risk: "Review strata records, building condition and flood context before purchase.", history: [{ date: "25 Sep 2026", event: "Listed for sale", price: "$900,000–$950,000" }, { date: "02 Feb 2021", event: "Sold", price: "$785,000" }] },
  { id: "kellyville", address: "26 Gumtree Avenue, Kellyville NSW 2155", suburb: "Kellyville", image: "/listing-kellyville.png", price: 1725000, priceGuide: "$1.68m–$1.78m", valuation: 1760000, valuationLow: 1660000, valuationHigh: 1870000, rent: 920, beds: 4, baths: 2, cars: 2, land: 510, type: "House", listed: "Listed 3 days ago", inspection: "Sat 1:15–1:45 pm", description: "Single-level family home with a practical floor plan, level rear garden and access to schools, parks and metro connections. The regular parcel provides a straightforward long-term ownership profile.", zoning: "R2 Low Density Residential", risk: "Bushfire and overland-flow screening should be confirmed through current council mapping.", history: [{ date: "23 Sep 2026", event: "Listed for sale", price: "$1.68m–$1.78m" }, { date: "09 Nov 2019", event: "Sold", price: "$1,080,000" }] },
  { id: "marrickville", address: "11 Silver Street, Marrickville NSW 2204", suburb: "Marrickville", image: "/listing-marrickville.png", price: 2380000, priceGuide: "Auction guide $2.30m", valuation: 2445000, valuationLow: 2310000, valuationHigh: 2580000, rent: 1250, beds: 4, baths: 3, cars: 1, land: 322, type: "Duplex", listed: "Auction in 12 days", inspection: "Thu 5:30–6:00 pm", description: "Contemporary inner-west residence balancing family accommodation with walkable dining, schools and rail access. Strong rental depth supports a flexible owner-occupier or hold strategy.", zoning: "R2 Low Density Residential", risk: "Verify heritage conservation context, party-wall obligations and aircraft-noise overlays.", history: [{ date: "21 Sep 2026", event: "Auction campaign launched", price: "Guide $2.30m" }, { date: "17 Aug 2017", event: "Site sold", price: "$1,260,000" }] },
  { id: "dee-why", address: "18/9 Pacific Parade, Dee Why NSW 2099", suburb: "Dee Why", image: "/listing-dee-why.png", price: 1290000, priceGuide: "$1.25m–$1.35m", valuation: 1315000, valuationLow: 1230000, valuationHigh: 1400000, rent: 895, beds: 2, baths: 2, cars: 1, land: 0, type: "Apartment", listed: "Listed 8 days ago", inspection: "Sat 9:30–10:00 am", description: "Modern coastal apartment with lift access, generous balcony and convenient links to beach, shops and express city transport. Indicative rent supports a resilient hold profile.", zoning: "R3 Medium Density Residential", risk: "Review strata capital works, salt exposure, waterproofing and coastal hazard information.", history: [{ date: "18 Sep 2026", event: "Listed for sale", price: "$1.25m–$1.35m" }, { date: "06 May 2020", event: "Sold", price: "$990,000" }] },
];
...
const extraInfo = {
  ...
  kellyville: { council: "The Hills Shire", built: "2019 (indicative)", floor: "224 m²", frontage: "14.8 m", rates: "$465/qtr", water: "$245/qtr", schools: ["Kellyville Public School · 1.1 km", "Kellyville High School · 1.8 km"], transport: ["Kellyville Metro · 1.6 km", "City bus · 350 m"], amenities: ["Kellyville Village · 1.2 km", "Local reserve · 0.4 km"], median: "$1.78m", growth: "+7.1%", population: "+3.2% p.a." },
  marrickville: { council: "Inner West Council", built: "2020 (indicative)", floor: "198 m²", frontage: "7.6 m", rates: "$490/qtr", water: "$270/qtr", schools: ["Marrickville Public School · 0.7 km", "Marrickville High School · 1.3 km"], transport: ["Marrickville Station · 0.8 km", "Metro bus · 220 m"], amenities: ["Marrickville Road dining · 0.4 km", "Henson Park · 0.8 km"], median: "$2.18m", growth: "+6.9%", population: "+1.9% p.a." },
  "dee-why": { council: "Northern Beaches Council", built: "2017 (indicative)", floor: "112 m²", frontage: "Strata property", rates: "$405/qtr", water: "$220/qtr", schools: ["Dee Why Public School · 0.9 km", "NBSC Cromer Campus · 2.4 km"], transport: ["B-Line bus · 0.5 km", "Local bus · 180 m"], amenities: ["Dee Why Beach · 0.7 km", "Town centre · 0.4 km"], median: "$1.16m", growth: "+5.4%", population: "+2.0% p.a." },
} as const;
      ...
      <div className="listing-grid">
        {listings.map((listing) => <article className={selected.id === listing.id ? "listing-card selected" : "listing-card"} key={listing.id}>
          <button type="button" onClick={() => choose(listing)} aria-label={`Analyse ${listing.address}`}>
            ...
            <div className="listing-card-body"><p>{listing.listed}</p><h3>{listing.address}</h3><div className="listing-facts"><span>{listing.beds} bed</span><span>{listing.baths} bath</span><span>{listing.cars} car</span><span>{listing.type}</span>{listing.land > 0 && <span>{listing.land} m²</span>}</div><div className="listing-card-value"><span>Modelled value</span><strong>{money(listing.valuation)}</strong></div><div className="listing-card-insights"><span><small>Est. rent</small><strong>{money(listing.rent)}/wk</strong></span><span><small>Gross yield</small><strong>{((listing.rent * 52 / listing.price) * 100).toFixed(2)}%</strong></span></div><p className="listing-inspection">Open home · {listing.inspection}</p></div>
          </button>
        </article>)}
      </div>
    </section>
