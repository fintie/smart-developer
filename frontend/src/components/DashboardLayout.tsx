    ...
    <main className="dashboard-page">
      ...
      <section className="dashboard-main">
        <header className="dashboard-header">
          <button className="header-brand" type="button" onClick={goHome} aria-label="Smart Developer home">
            <span className="brand-symbol"><i /><i /><i /></span>
            <span><strong>Smart Developer</strong><small>Property intelligence</small></span>
          </button>
          <div className="header-actions">
            <span className="live-status"><i />Property intelligence online</span>
            <div className="account-menu-wrap" ref={accountMenuRef}>
              <button className="header-avatar menu-trigger" type="button" onClick={() => setAccountMenuOpen((open) => !open)} aria-expanded={accountMenuOpen} aria-haspopup="menu" aria-label="Open account and navigation menu">{user?.avatar ? <img src={user.avatar} alt="" /> : initials}<span aria-hidden="true">⌄</span></button>
              {accountMenuOpen && <div className="account-menu" role="menu">
                ...
                <button type="button" role="menuitem" onClick={() => selectSection("listings")}>Listings <span>⌂</span></button>
                <button type="button" role="menuitem" onClick={() => selectSection("opportunities")}>Opportunity Finder <span>⌕</span></button>
